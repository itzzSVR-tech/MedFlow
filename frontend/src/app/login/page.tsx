                ...
                <div className="p-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-500">
                            Sign in to your specialized dashboard
                        </p>
                    </div>
                    ...
                    >
                        <TabsList className="grid w-full grid-cols-3 p-1 bg-slate-100 rounded-2xl h-14">
                            <TabsTrigger
                                value="admin"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            {loading
                                ? "Signing in..."
                                : `Sign In as ${activeTab === "admin" ? "Admin" : activeTab === "doctor" ? "Staff" : "Patient"}`}
                            {!loading && (
