...
const hospital_middleware_1 = require("../middlewares/hospital.middleware");
const router = (0, express_1.Router)();
// All doctor routes require 'doctor' role and hospital association
router.use((0, role_middleware_1.roleMiddleware)(['doctor']));
router.use(hospital_middleware_1.hospitalMiddleware);
